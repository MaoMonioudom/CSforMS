  ...
  return (
    <div className="rounded-2xl p-4 sm:p-5" style={{ background: gradient }}>
      <div className="mb-2 flex items-center justify-between">
        ...
        <span className="rounded-md bg-white/50 px-2 py-0.5 text-xs font-semibold text-charcoal/60">{period}</span>
      </div>
      <p className="m-0 text-2xl font-bold tracking-tight text-charcoal sm:text-2xl">{value}</p>
      {isUp !== null && (
