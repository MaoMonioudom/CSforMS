...
export default function BookShell({
  ...
  return (
    ...
    >
      <div className="relative aspect-[3/4.4] w-full max-sm:aspect-[3/4]">
        <div className="absolute inset-0 flex origin-left overflow-hidden rounded-[3px_6px_6px_3px] shadow-[4px_6px_18px_rgba(60,38,20,0.35),inset_0_1px_0_rgba(255,255,255,0.15)] transition-[transform,box-shadow] duration-[450ms] ease-[cubic-bezier(0.2,0.7,0.3,1)] [transform-style:preserve-3d] group-hover:shadow-[10px_14px_26px_rgba(60,38,20,0.4),inset_0_1px_0_rgba(255,255,255,0.15)] group-hover:[transform:rotateY(-8deg)_translateX(-2px)] group-focus-visible:shadow-[0_0_0_3px_#7C2A22] group-focus-visible:[transform:rotateY(-8deg)_translateX(-2px)]">
          {/* Spine with gilt edges */}
          <div
            className="relative w-3.5 shrink-0 shadow-[inset_-2px_0_4px_rgba(0,0,0,0.35)] after:absolute after:inset-0 after:bg-[linear-gradient(180deg,rgba(201,168,76,0.5),transparent_12%,transparent_88%,rgba(201,168,76,0.5))] after:content-['']"
          ...
          >
            ...
            <div className="relative z-[1] flex min-h-0 flex-1 flex-col justify-end">
              <p className="mb-1 font-display text-lg font-bold leading-[1.25] text-[#F6ECD3] [text-shadow:0_1px_2px_rgba(0,0,0,0.4)]">
                {title}
              </p>
          ...
          {/* Gilt page edges along the right side */}
          <div
            aria-hidden="true"
            className="absolute bottom-[3px] right-0 top-[3px] w-1.5 bg-[repeating-linear-gradient(180deg,#E8D9A8_0px,#C9A84C_2px,#E8D9A8_3px)] shadow-[inset_2px_0_3px_rgba(0,0,0,0.2)]"
          />
        </div>
      </div>
    </article>
