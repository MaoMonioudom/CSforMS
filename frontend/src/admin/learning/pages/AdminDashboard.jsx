  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Overview of the CADT Learning platform.</p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-border p-5">
          <h2 className="text-sm font-bold text-foreground mb-3">Students per course</h2>
          {courses.length === 0 ? (
                ...
                .map((c) => (
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground">{c.category} · {c.instructor || "Unassigned"}</p>
                    </div>
        ...
        <div className="bg-white rounded-xl border border-border p-5">
          ...
          {activity.length === 0 ? (
            <p className="text-sm text-muted-foreground">No enrollments or purchases yet.</p>
          ) : (
            <div className="divide-y divide-gray-50">
              {activity.slice(0, 10).map((a, i) => (
                <div key={i} className="flex items-center gap-3 py-2.5">
                  ...
                  <p className="text-sm text-foreground min-w-0 flex-1 truncate">
