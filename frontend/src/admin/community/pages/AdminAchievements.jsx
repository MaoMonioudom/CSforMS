    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {list.map((a) => (
            <div key={a.achievement_id} className="bg-white rounded-xl border border-border p-4 flex gap-3">
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="grid gap-4">
            ...
            <div>
              <label className={labelCls}>Description <span className="font-normal text-muted-foreground">(optional)</span></label>
            ...
            <div>
              <label className={labelCls}>Badge icon <span className="font-normal text-muted-foreground">(optional)</span></label>
