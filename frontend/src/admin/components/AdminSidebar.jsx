...
import {
  ...
  Boxes, Printer, RotateCcw, Inbox, CreditCard, Compass,
  GraduationCap, Armchair,
} from "lucide-react";

// One shared, resizable admin sidebar for all three modules. Each module is a
// collapsible folder; the folder whose routes match the current URL starts open.
const FOLDERS = [
  {
    id: "community",
    label: "Community Space",
    match: (p) => p.startsWith("/admin/community"),
    items: [
