...
const LABEL = "text-xs font-semibold uppercase tracking-[0.08em] text-navy-muted";
const INPUT =
  "field border-community-gold/20 bg-navy text-parchment outline-none focus:border-community-gold focus:ring-2 focus:ring-community-gold/20";
...
export default function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-navy-deep p-4">
      <div className="w-full max-w-[380px] rounded-lg border border-community-gold/15 bg-navy px-6 py-8">
        <Link to="/learning" className="mb-6 block text-base text-parchment">
          📚 Makerspace Learning
        </Link>
        <h1 className="mb-1.5 text-2xl text-parchment">Staff Sign In</h1>
        ...
        <form className="flex flex-col gap-4" onSubmit={submit}>
          ...
          <button
            type="submit"
            className="btn-primary mt-2 w-full cursor-pointer justify-center bg-community-gold text-navy hover:bg-community-gold-light"
          >
            Sign In
          </button>
        </form>
