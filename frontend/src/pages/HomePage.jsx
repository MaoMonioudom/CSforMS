...
function BoardLabel({ children, rotate = -0.8, pinColor = "#c53030" }) {
  return (
    <div className="relative inline-flex items-center">
      ...
      <div
        className="bg-white/90 backdrop-blur-sm px-6 py-2 shadow-md"
        style={{
      ...
      >
        <span className="text-2xl font-bold text-foreground tracking-wide">{children}</span>
      </div>
    </div>
  );
}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pt-10 pb-16 flex flex-col lg:flex-row gap-10 items-start">
          ...
          <Pinned rotate={-1} pinColor="#b91c1c" className="flex-1 max-w-xl">
            <div className="relative bg-white/96 p-8 sm:p-10" style={{ boxShadow: "6px 10px 36px rgba(0,0,0,0.32)" }}>
              ...
              <h1 className="text-6xl sm:text-7xl font-bold text-foreground leading-[0.95]">
                Community<br />
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-10 pt-4">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10 pt-4">
