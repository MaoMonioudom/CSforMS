...
import { ArrowLeft, Mail, MessageCircle, Send, Users } from "lucide-react";
import {
  collabTypeEmoji,
  collabTypeLabel,
  formatRelativeTime,
  ...
  if (!post) {
    return (
      <div className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <Link to="/collaboration" className="mt-6 inline-block text-collaboration underline">
  ...
  return (
    <main className="bg-background">
      <div className="bg-collaboration/10">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-10 pb-12">
          <button
            onClick={() => navigate(-1)}
